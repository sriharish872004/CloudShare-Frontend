    ...
    <div className='py-16 bg-blue-50'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-gary-900 sm:text-4xl">
            Everything you need for the file sharing
          </h2>
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
            CloudShare provide all the tools to manage your digital content
          </p>
        </div>
              ...
              {features.map((feature, index) => (
                <div key={index} className='pt-5 border border-gray-100 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 bg-white'> 
                  <div className='flow-root bg-gray-50 rounded-lg px-6 pb-8'>
                    <div className='-mt-6'>
                      <div className='inline-flex item-center justify-center p-3 bg-white rounded-md shadow-lg'>
