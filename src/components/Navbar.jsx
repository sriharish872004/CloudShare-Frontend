...
const Navbar = ({activeMenu}) => {
    ...
    return (
        <div className='flex item-center justify-between gap-5 bg-white border border-b border-gray-200/50 backdrop-blur-[2px] py-4 px-4 sm:px-7 sticky top-0 z-30'>
            {/* Left side - menu button and title */}
            <div className='flex item-center gap-5'>
                <button className='block lg:hidden text-black hover:bg-gray-100 p-1 rounded-lg transition-colors'
